#!/bin/bash
# Keycloak Deployment Script (ECR Version)
# Prerequisites: 
...
echo "=========================================="
echo "🚀 Keycloak Deployment (ECR Images)"
echo "=========================================="
echo ""
...
services:
  keycloak-db:
    image: 361568250748.dkr.ecr.ap-south-1.amazonaws.com/keycloak-postgres:15
  ...
  keycloak:
    image: 361568250748.dkr.ecr.ap-south-1.amazonaws.com/keycloak:26.4.1
  ...
  nginx:
    image: 361568250748.dkr.ecr.ap-south-1.amazonaws.com/keycloak-nginx:alpine
